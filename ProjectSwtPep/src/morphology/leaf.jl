...
@system Leaf(Organ, LeafColdInjury) begin
    ...
    area_ratio => 0.6 ~ preserve(parameter)
    ...
    area_from_length(; L(u"cm")) => begin
        ...
        iszero(l) ? l : 0.2034l^2 + 1.1487l # Modify for sweet pepper
        # ref: https://www.scielo.br/j/cr/a/vvnvdJZmhsTmz5dMTF7fmBs/?lang=en#ModalFigf1
    end ~ call(u"cm^2")
